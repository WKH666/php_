...
<script >
    $(document).ready(function(){
        ...
        var h = $.bootsform({
            ...
            submitfields:'name,tables,type,num,table,sort,status,where,summary,summarx,pctx,mctx,wxtx,emtx,isflow,sericnum,receid,recename,names,statusstr,isgbjl,isgbcy,isgblc,isgbcllc,ischecksuccess',
    ...
    <div  style="padding:10px;width:700px">
        ...
        <form name="form_{rand}">
            ...
            <table cellspacing="0" border="0" width="100%" align="center" cellpadding="0">
                ...
                <tr>
                    <td  align="right" width="15%" nowrap ><font color=red>*</font> 模块编号：</td>
                ...
                <tr>
                    ...
                    <td class="tdinput" colspan="3"><textarea  name="summarx" placeholder="title:{title}optdt:{optdt}cont:" style="height:100px" class="form-control"></textarea>
                ...
                <tr>
                    ...
                    <td class="tdinput" colspan="3">
                        ...
                        <label><input name="pctx" value="1" type="checkbox"> PC提醒</label>&nbsp; &nbsp;
                ...
                <tr>
                    ...
                    <td class="tdinput" colspan="3"><input name="statusstr" class="form-control"><a click="setstatus">[设置]</a><font color=#888888>默认状态值是：【待处理|blue,已审核|,未通过|red】对应值从0开始，其中0,1,2,5固定的5是作废,1必须是已完成,已审核状态</font></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="tdinput" colspan="3">
                        ...
                        <label><input name="isgblc" value="1" type="checkbox"> 不显示添加申报中的流程信息</label>&nbsp; &nbsp;
<!--                        <label><input name="isgbcllc" value="1" type="checkbox"> 不显示添加申报中的流程信息</label>&nbsp; &nbsp;-->
...
<!--                        <label><input name="ishz" value="1" type="checkbox"> 开启回执确认</label>-->
                ...
                <tr>
                    <td  align="right" >处理表单上：</td>
                    <td class="tdinput" colspan="3">
                        <label><input name="ischecksuccess" value="1" type="checkbox"> 结果默认选择通过</label>&nbsp; &nbsp;
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="padding:15px 0px" colspan="3" align="left"><button disabled class="btn btn-success" id="save_{rand}" type="button"><i class="icon-save"></i>&nbsp;保存</button>&nbsp; <span id="msgview_{rand}"></span>&nbsp;
                        	<a href="" target="_blank">[看帮助]</a>查看各个字段说明
                    </td>
                </tr>
