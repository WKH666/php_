...
$(document).ready(function(){
	...
	var h = $.bootsform({
		...
		submitfields:'name,fields,fieldstype,dev,savewhere,sort,islu,isbt,iszs,data,iszb,isdr,attr,lens',
...
<div  style="padding:10px;width:700px">
	...
	<form name="form_{rand}">
		...
		<tr>
			<td  align="right"></td>
			<td style="padding:15px 0px" colspan="3" align="left"><button disabled class="btn btn-success" id="save_{rand}" type="button"><i class="icon-save"></i>&nbsp;保存</button>&nbsp; <span id="msgview_{rand}"></span></td>
		</tr>
