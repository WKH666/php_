...
$(document).ready(function(){
	...
	var h = $.bootsform({
		...
		submitfields:'explain,status,num,whereid,changefields,changecourse,boturn,boedit,bochang,bodel,bozuofei,botong,bobutong,bozhui,receid,recename,setid,toturn,tocourse,bozhuan,todofields,summary',
		success:function(){
			closenowtabs();
...
<div  style="padding:10px;width:650px">
	...
	<form name="form_{rand}">
		...
		<tr>
			...
			<label><input name="bochang" click="changfields" type="checkbox" value="1">字段改变时</label>&nbsp; 
