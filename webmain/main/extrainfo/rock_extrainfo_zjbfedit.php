...
$(document).ready(function(){
	...
	var id = params.id;
	if(!id)id = 0;
	var submitfields = 'mtype,mid,file_ids,appropriation_time';
	var h = $.bootsform({
		window:false,rand:'{rand}',tablename:'mf_appropriation',
		url:js.getajaxurl('saveappropriation','extrainfo','main'),
	...
	if(id!=0){//如果是编辑，则获取相应的表单数据
		h.load(js.getajaxurl('loadform','extrainfo','main',{id:id,table:jm.base64encode('appropriation')}));
		js.ajax(js.getajaxurl('getupfiles','extrainfo','main'),{id:id,table:jm.base64encode('appropriation')},function(da){
