...
$(document).ready(function(){
	...
	a = $('#view_{rand}').bootstable({
		url:js.getajaxurl('evaluation','extrainfo','main',{mid:lx}),fanye:true,storeafteraction:'extrainfoafter',storebeforeaction:'dataauthbefore',
		columns:[{
...
function evaluation_add(lx,mtype,project_name){
	evaluationlist = a;
	addtabs({num:'evaluation_add'+lx,url:'main,extrainfo,jxkpedit,mid='+lx+',mtype='+mtype+',project_name='+project_name,icons:'icon-bookmark-empty',name:'录入['+project_name+']验收信息'});
}
...
function evaluation_edit(lx,mtype,id,project_name){
	evaluationlist = a;
	addtabs({num:'evaluation_edit'+lx,url:'main,extrainfo,jxkpedit,id='+id+',mtype='+mtype+',mid='+lx+',project_name='+project_name,icons:'icon-bookmark-empty',name:'编辑['+project_name+']验收信息'});
}
