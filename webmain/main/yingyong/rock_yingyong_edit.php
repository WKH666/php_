...
$(document).ready(function(){
	...
	var h = $.bootsform({
		...
		submitfields:'sort,name,recename,iconfont,types,iconcolor,receid,url,face,valid,num,pid,yylx,urlpc,urlm',
...
<div  style="padding:10px;width:700px">
	...
	<form name="form_{rand}">
		...
		<tr>
			...
			<td class="tdinput"><input name="iconfont" placeholder="没有可不用填" class="form-control"></td>
		
			<td  align="right" >字体图标颜色：</td>
			<td class="tdinput"><input name="iconcolor" placeholder="没有可不用填" class="form-control"></td>
		</tr>
		<tr>
