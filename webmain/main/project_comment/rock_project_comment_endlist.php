...
<script >
    ...
    $(document).ready(function(){
        ...
        a = $('#view_{rand}').bootstable({
            url:js.getajaxurl('endlist','project_comment','main',{'atype':atype}),
    ...
    //查看
    function look(id){
        if(get('tabs_look_batch')) closetabs('look_batchEnd');
        addtabs({num:'look_batchEnd',url:'main,project_comment,end_pcig,pici_id='+id,icons:'icon-bookmark-empty',name:'查看批次'});
        thechangetabs('look_batchEnd');
    }
