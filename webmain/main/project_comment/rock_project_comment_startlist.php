...
<script >
    ...
    $(document).ready(function(){
        ...
        a = $('#view_{rand}').bootstable({
            url:js.getajaxurl('startlist','project_comment','main',{'atype':atype}),
    ...
    //查看
    function look_startlist(id){
        if(get('tabs_look_batch')) closetabs('look_batchStart');
        addtabs({num:'look_batchStart',url:'main,project_comment,start_pcig,pici_id='+id,icons:'icon-bookmark-empty',name:'查看批次'});
        thechangetabs('look_batchStart');
    }
