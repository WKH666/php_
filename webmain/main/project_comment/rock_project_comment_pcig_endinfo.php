...
<script>
    ...
    function read_comment_info(pici_id,xid) {
        ...
        addtabs({num:'read_comment_info',url:'main,project_comment,end_readinfo,pici_id='+pici_id+',xid='+xid+',pinshentype=project_end',icons:'icon-bookmark-empty',name:'评审信息'});
    }
    //项目信息表格查询
...
<ul id="myTabEnd_{rand}" class="nav nav-tabs">
	<li class="active">
		<a href="#endProjectInfo" data-toggle="tab">项目信息</a>
	</li>
	<li><a href="#endPingshenInfo" data-toggle="tab">评审信息</a></li>
	<li><a href="#endZhibiaoInfo" data-toggle="tab">指标信息</a></li>
</ul>
<div id="myTabContent" class="tab-content">
	<div class="tab-pane fade in active" id="endProjectInfo">
        <form>
	...
	<div class="tab-pane fade" id="endPingshenInfo">
        <form>
            <section class="serachPanel selBackGround">
                <div class="searchAPanel">
                    <div class="searchAc1">
	...
	<div class="tab-pane fade" id="endZhibiaoInfo">
		<p>
				<div align="center">
