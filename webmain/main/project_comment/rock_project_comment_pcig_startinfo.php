...
//		}
    ...
    function read_comment_info(pici_id,xid) {
        if(get('read_start_readinfo')) closetabs('read_start_readinfo');
        addtabs({num:'read_start_readinfo',url:'main,project_comment,start_readinfo,pici_id='+pici_id+',xid='+xid+',pinshentype=project_start',icons:'icon-bookmark-empty',name:'评审信息'});
    }
    //项目信息表格查询
