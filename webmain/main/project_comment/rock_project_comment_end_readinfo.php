...
<script >
    ...
    $(document).ready(function(){
        ...
        a = $('#view_{rand}').bootstable({
                url:js.getajaxurl('expert_score','project_comment','main',{pici_id:pici_id,xid:xid,pinshenType:'project_end'}),
    ...
    var xids = '';
    //扣罚弹窗
    function penalty_end_func(pici_id,uid,xid) {
    ...
    //已提交人的指标信息
    function preview_end(pici_id,mid,mtype,uid) {
        js.ajax(js.getajaxurl('expert_dafen', 'project_comment', 'main'), {pici_id:pici_id,mid:mid,mtype:mtype,uid:uid}, function(ds) {
            ...
            var url = getRootPath()+'/webmain/main/project_comment/rock_project_comment_norm_look.php?pinshentype=project_end';
            js.open(url,900,600);
        }, 'post,json');
    }
    //未提交人的指标信息
    function look_end(norm_id) {
        var url = getRootPath()+'/webmain/main/project_comment/rock_project_comment_norm_look.php?pinshentype=project_end&norm_id='+norm_id;
        js.open(url,900,600);
    }
    ...
    <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="send_penalty_end()">保存</button>
