...
<script>
    $(document).ready(function () {
        ...
        var a = $('#admin_{rand}').bootstable({
            ...
            celleditor: true,
            fanye: true,
            storebeforeaction: 'beforeshow',
            params: {atype: 'gl'},
            modedir: '{mode}:{dir}',
            fieldsafteraction: 'fieldsafters',
            columns: [
//		{
...
//		},
                {
                    ...
                    text: '高校', dataIndex: 'school_name', sortable: true
                }, {
                    text: '状态',
                    dataIndex: 'status',
                    type: 'checkbox',
                    editor: (HOST.indexOf('55.com') == -1),
                    sortable: true
                }, {
                    text: '管理员', dataIndex: 'is_admin', type: 'checkbox', sortable: true
                }, {
    ...
    <table width="100%">
        <tr>
            ...
            <td style="padding-left:10px">
                <button class="btn btn-primary" click="piliang,0" type="button"><i class="icon-plus"></i> 批量添加用户
                </button>
            </td>
            <td style="padding-left:10px">
                <div class="input-group" style="width:250px">
                    <input class="form-control" id="key_{rand}" placeholder="姓名/部门/职位/工号">
            ...
            <!--<td  style="padding-left:10px">
                <button class="btn bgGray btn-default" click="daochu,1" type="button">导出</button>
            </td>-->
            <td width="80%"></td>
            <td align="right" nowrap>
                <button class="btn btn-info" id="edit_{rand}" click="clickwin,1" disabled type="button"><i
                            class="icon-edit"></i> 编辑
                </button> &nbsp;
                <button class="btn btn-success" click="refresh" type="button"><i class="icon-refresh"></i> 更新数据</button>
                &nbsp;
                <button class="btn btn-danger" id="del_{rand}" click="del" disabled type="button"><i
