...
//		},
	...
	chsksse{rand}=function(oi){
		...
		var s = $('input[type="checkbox"][oi="'+oi+'"]').attr('checked','checked');
		c.yiduT();
	}
	var c = {
		del:function(){
		...
		yidu:function(o1, lx){
			...
			this.yidchulst(s, true);
		},
		yiduT:function(o1, lx){
			var s = a.getchecked();
			if(s==''){
				return;
			}
...
<ul class="floats">
	<li class="floats50">
		<button class="btn_ " click="yidu,1"  type="button">标为已读</button>
	</li>
