function initbody(){
	...
	var ddsata=[{
		...
		name:'<i class="icon-question-sign"></i> 流程说明',num:'msg',url:'system,liucheng,msg',names:'流程说明'
	},
/*	{
		name:'<i class="icon-picture"></i> 修改头像',num:'face'
	},*/
	{
		name:'<i class="icon-user"></i> 帐号',num:'user'
	},{
			name:'<i class="icon-user"></i> 个人信息',num:'user_info',url:'system,user,info',names:'个人信息'
	}];
