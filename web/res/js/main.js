...
function addtabs(d){
	...
	var ura	= d.url.split(',');
	var url = 'html/pl_'+ura[0]+'.shtml?rnd='+Math.random()+'';
...
var im={
	init:function(){
		...
		systemtitle = js.getoption('systemtitle','迈峰');
...
function agentclass(opts){
	...
	this.listright=function(oi,event){
		...
		var da = [/*{name:'详情',lx:998,oi:oi,nbo:false},*/{name:'详情',lx:998,oi:oi,nbo:true}];
